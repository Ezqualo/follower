...
<div class="container-fluid table-wrapper" style="background-color: #000000;">
    ...
    if (empty($subject2) == false){
        //echo "Funciona";
        $fechas_dif = $mysqli -> query("SELECT fechaInicio, fechaSalida FROM piezas WHERE nombre = '$subject2'");
        ...
        $fechas_dif = $mysqli -> query("SELECT idOdt, fechaSolicitud, fechaEntrega FROM odts WHERE proyecto = '$subject'");
                ...
                ?>
                    ...
                    <table class="table table-condensed table-bordered" id="table_tt">
                        ...
                        <tr>
                            ...
                            <?php
                            if (empty($subject2) == false){
                                $sql_semaforo = $mysqli -> query("SELECT semaforo FROM piezas WHERE nombre = '$subject2'");
				...
				echo '<td> 
					...
					<div class="radio-item">';
					    ...
					    echo '<label id="cerradolabel" for="CerradoB"></label>
                                ...
                                $sql_semaforo = $mysqli -> query("SELECT semaforo FROM odts WHERE idOdt = '$idodt'");
                                while($colores_semaforo = mysqli_fetch_array($sql_semaforo)) {
                                    $color_semaforo = $colores_semaforo[semaforo];
                                }
...
<div class="modal fade" id="modalPieza" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel_b" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="../bd/save_piezasNew.php" method="POST">
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                        ...
                        <div class="col">
                            ...
                            <input type="text" class="form-control"  id="nom_proyecto" name="nom_proyecto" class="nom_proyecto" value="<?php echo $subject; ?>" hidden>
...
<div class="modal fade" id="modalevento" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <label>Comentario</label>
                <input type="text" name="" id="comentarioO" class="form-control input-sm">
                <label>Color</label>
                <input type="color" id="color_eventO" class="form-control input-sm">
                <input type="text" id="dia_eventO" class="form-control input-sm" >
                <input type="text" id="coment_asigO" class="form-control input-sm" >
                <input type="text" id="proyectoeO" class="form-control input-sm" >
                <input type="text" id="piezaeO" class="form-control input-sm" >
            </div>
            <div class="modal-footer">
