    ...
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <label>Motivo</label>
                <input type="text" id="motivo_up" class="form-control input-sm" required>
...
<div class="modal fade" id="modalPiezaEdit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer ">
                <button type="button" class="btn btn-warning" id="actualizadatosPieza" data-dismiss="modal">Actualizar
                </button>
