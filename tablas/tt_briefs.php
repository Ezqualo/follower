...
<div class="container-fluid sticky-top" style="background-color: #000000;" align="center">
   ...
   <div class="container-fluid table-wrapper" style="background-color: #000000;">
    ...
    if (empty($subject2) == false){
        //echo "Funciona";
        $fechas_dif = $mysqli -> query("SELECT fechaInicio, fechaSalida FROM piezasBrief WHERE nombre = '$subject2' AND id = '$id'");
	...
	echo $subject;
        $fechas_dif = $mysqli -> query("SELECT fechaEntrega, fechaSalida FROM briefs WHERE nombre = '$subject' AND id = '$id'");
                ...
                ?>
                    ...
                    <table class="table table-condensed table-bordered" id="table_tt">
                        ...
                        <tr>
                            ...
                            <?php
                            if (empty($subject2) == false){
                                $sql_semaforo = $mysqli -> query("SELECT id,semaforo FROM piezasBrief WHERE nombre = '$subject2'");
					...
					<div class="radio-item">';
					    if( $color_semaforo=="#FFC500" ){
					        ...
					        echo '<input onclick="act_semaforo_pb('.$a.',value)" type="radio" id="InicioC" name="droneC" checked value="#FFC500">';
					    }else{
					        echo '<input onclick="act_semaforo_pb('.$a.',value)" type="radio" id="InicioC" name="droneC" value="#FFC500">';
					    }
					    echo '<label id="iniciolabel" for="InicioC"></label>
					</div>
					<div class="radio-item">';
					    if($color_semaforo=="#1CB707"){
					        echo '<input onclick="act_semaforo_pb('.$a.',value)" type="radio" id="EnviadoC" name="droneC" checked value="#1CB707">';
					    }else{
					        echo '<input onclick="act_semaforo_pb('.$a.',value)" type="radio" id="EnviadoC" name="droneC" value="#1CB707">';
					    }

					    echo '<label id="enviadolabel" for="EnviadoC"></label>
					</div>
					
					<div class="radio-item">';
					if($color_semaforo=="#FF0C00"){
					    echo '<input onclick="act_semaforo_pb('.$a.',value)" type="radio" id="PausadoC" name="droneC" checked value="#FF0C00">';
					}else{
					    echo '<input onclick="act_semaforo_pb('.$a.',value)" type="radio" id="PausadoC" name="droneC" value="#FF0C00">';
					}
					
					echo '<label id="pausadolabel" for="PausadoC"></label>
					</div>
					<div class="radio-item">';
					    if($color_semaforo=="#6900D1"){
					        echo '<input onclick="act_semaforo_pb('.$a.',value)" type="radio" id="CerradoC" name="droneC" checked value="#6900D1">';
					    }else{
					        echo '<input onclick="act_semaforo_pb('.$a.',value)" type="radio" id="CerradoC" name="droneC" value="#6900D1">';
					    }
					    
					    echo '<label id="cerradolabel" for="CerradoC"></label>
					</div>

				    </td>';

                            } else{
                                $sql_semaforo = $mysqli -> query("SELECT id,semaforo FROM briefs WHERE nombre = '$subject'");
                                while($colores_semaforo = mysqli_fetch_array($sql_semaforo)) {
                                    $color_semaforo = $colores_semaforo[semaforo];
				...
				echo '<td> 
					...
					<div class="radio-item">';
					    if( $color_semaforo=="#FFC500" ){
					        ...
					        echo '<input onclick="act_semaforo_b('.$ap.',value)" type="radio" id="InicioD" name="droneD" checked value="#FFC500">';
					    }else{
					        echo '<input onclick="act_semaforo_b('.$ap.',value)" type="radio" id="InicioD" name="droneD" value="#FFC500">';
					    }
					    echo '<label id="iniciolabel" for="InicioD"></label>
					</div>
					<div class="radio-item">';
					    if($color_semaforo=="#1CB707"){
					        echo '<input onclick="act_semaforo_b('.$ap.',value)" type="radio" id="EnviadoD" name="droneD" checked value="#1CB707">';
					    }else{
					        echo '<input onclick="act_semaforo_b('.$ap.',value)" type="radio" id="EnviadoD" name="droneD" value="#1CB707">';
					    }

					    echo '<label id="enviadolabel" for="EnviadoD"></label>
					</div>
					<div class="radio-item">';
					if($color_semaforo=="#FF0C00"){
					    echo '<input onclick="act_semaforo_b('.$ap.',value)" type="radio" id="PausadoD" name="droneD" checked value="#FF0C00">';
					}else{
					    echo '<input onclick="act_semaforo_b('.$ap.',value)" type="radio" id="PausadoD" name="droneD" value="#FF0C00">';
					}
					
					echo '<label id="pausadolabel" for="PausadoD"></label>
					</div>
					<div class="radio-item">';
					    if($color_semaforo=="#6900D1"){
					        echo '<input onclick="act_semaforo_b('.$ap.',value)" type="radio" id="CerradoD" name="droneD" checked value="#6900D1">';
					    }else{
					        echo '<input onclick="act_semaforo_b('.$ap.',value)" type="radio" id="CerradoD" name="droneD" value="#6900D1">';
					    }
					    
					    echo '<label id="cerradolabel" for="CerradoD"></label>
					</div>
                            ...
                            if($mes1 == $mes2){
                                while($cont <= $dia2){
                                    if($n == 0 || $n == 6){
                                        ...
                                        if(empty($subject2) == false){
                                            //echo " entre al ciclo";
                                            $sql_fechaAnt = $mysqli -> query("SELECT fechaAnterior FROM piezasBrief WHERE nombre = '$subject2' AND id = '$id'");
                                            ...
                                            $sql_fechaAnt = $mysqli -> query("SELECT fechaAnterior FROM briefs WHERE nombre = '$subject' AND id = '$id'");
                                            while($valor_fecha_anterior = mysqli_fetch_array($sql_fechaAnt)){
                                                $fecha_Ant = $valor_fecha_anterior[0];
                                                $fechaAnteriorOdt = substr($fecha_Ant, 8, 2);
                                                if($cont < 10){
                        ...
                        if($mes1 == $mes2){//CONDICION PARA CUANDO EL PERIODO SEA DENTRO DEL MISMO MES
                            ...
                            if (empty($subject2) == true){
                                ...
                                include_once 'piezas_brief_un_mes.php';
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="fechaAnterior_Com_B" id="fechaAnterior_Com_B" class="form-control input-sm" hidden>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <form action="../bd/save_piezas_briefNew.php" method="POST">
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <input type="text" class="form-control"  id="nom_proyecto_b" name="nom_proyecto_b" class="nom_proyecto_b" value='<?php echo utf8_encode($subject); ?>' hidden>
    ...
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <input type="text" id="dia_eventb" class="form-control input-sm" hidden>
                <input type="text" id="coment_asigb" class="form-control input-sm" hidden>
    ...
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <input type="text" id="proyectoe_u" class="form-control input-sm" >
                <input type="text" id="piezae_u" class="form-control input-sm" >
            </div>
            <div class="modal-footer">
