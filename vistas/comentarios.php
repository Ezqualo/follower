                        ...
                        <div class="wrapper" >
                            <section class="chat-area">
                                <header>
                                    ...
                                    $query = $mysqli->query("SELECT DISTINCT cliente FROM odts WHERE proyecto = '$proyecto_buscar'");
                                    while ($valores = mysqli_fetch_array($query)) {
                                        $user_chat = $valores[cliente];
                                    }

                                    $query2 = $mysqli->query("SELECT DISTINCT mailCliente FROM clientes WHERE nombreCliente = '$user_chat'");
                                    while ($valores = mysqli_fetch_array($query2)) {
                                        $user_mail = $valores[mailCliente];
                                    }

                                    ?>
                                    <img src="../chat/userpics/user3.jpg" alt="">
                                    <div class="details">
                                        <span><?php echo $user_chat?></span>
                                ...
                                <form action="#" class="typing-area">
                                    <input type="text" class="outgoing_id" name="outgoing_id" value="<?php echo $userlogin; ?>" hidden>
                                ...
                                <input type="text" class="" name="correoCliente" id="correoCliente" value="<?php echo $user_mail; ?>" hidden>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('#publicar').click(function() {
                ...
                correoCliente = "f.rodriguez@ezqualo.com";
