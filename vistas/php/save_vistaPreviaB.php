<?php 
	...
	$sql_pieza = $mysqli -> query("SELECT * FROM previaPiezasb WHERE idPiezaBrief = '$id_pieza' AND fechafinal = '$salida'");
	...
	if($row_cnt == 0){
		...
		$sql="INSERT INTO previaPiezasb (idPiezaBrief,fechafinal,horas,recursos,cambios,imagen1,imagen2,imagen3,archivo) VALUES ('$id_pieza','$salida','$horas','$recursos','$cambios','$n1,'$n2','$n3','$a')";
		...
		$sql="UPDATE previaPiezasb SET idPiezaBrief='$id_pieza', horas='$horas', recursos='$recursos', cambios='$cambios',fechafinal='$salida' $txt $txt2 WHERE id='$id'";
		echo $result=mysqli_query($conexion,$sql);
		//echo $sql;
	}
	//echo $sql;
