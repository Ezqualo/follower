                    ...
                    <div class="div_izquierda">
                        <table class="table table-striped table-dark tree">
                            ...
                            while($columnas=mysqli_fetch_array($sql)) {
                                ...
                                $sql_piezas=$mysqli -> query("SELECT piezasBrief.nombre, piezasBrief.fechaInicio, piezasBrief.fechaSalida FROM piezasBriefs inner join briefs on piezasBrief.idPieza = briefs.id AND briefs.nombre = '$nom_proy' AND piezasBrief.nombre = '$pieza_recibida'");
                        ...
                        <div class="wrapper" >
                            <section class="chat-area">
                                <header>
                                    ...
                                    $query = $mysqli->query("SELECT DISTINCT ejecutiva FROM briefs WHERE nombre = '$proyecto_buscar'");
                                    while ($valores = mysqli_fetch_array($query)) {
                                        $user_chat = $valores[ejecutiva];
                                    }
